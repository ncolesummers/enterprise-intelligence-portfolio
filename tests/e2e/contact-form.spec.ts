...
test.describe("Contact Form - UI Behavior", () => {
  ...
  test.describe("Email Verification", () => {
    test("should submit correct email address to FormSpree", async ({
      page,
    }) => {
  ...
  test.describe("Cross-Browser Email Handling", () => {
    test("should maintain email integrity across browsers", async ({
      page,
      browserName,
    }) => {
      ...
      console.log(
        `✅ Email integrity maintained in ${browserName}: ${testEmail}`,
      );
    });
  });
});
