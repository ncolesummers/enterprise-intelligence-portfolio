...
export const emailTestConfig: EmailTestConfig = {
  expectedRecipient: process.env.EXPECTED_EMAIL_RECIPIENT || 'nate@ncolesummers.com',
  formspreeEndpoint: process.env.FORMSPREE_ENDPOINT || 'https://formspree.io/f/xeogbrzn',
