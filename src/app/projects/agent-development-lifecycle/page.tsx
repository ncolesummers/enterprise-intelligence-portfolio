        ...
        <div className="grid gap-8 md:grid-cols-2">
          <div>
            <p className="mb-4 text-lg text-muted-foreground">
              ...
              effective harnesses for long-running autonomous coding agents. The
              reference implementations and quickstart examples are exclusively
              Python SDK, leaving the broader Node.js and TypeScript ecosystem
              without a production-grade equivalent.
            </p>
            <p className="mb-4 text-lg text-muted-foreground">
          ...
          <ContentCard>
            ...
            <BulletedList>
              <ListItem>
                ...
                (Nov 2025) — Two-agent pattern, feature list as source of truth,
                progress tracking, boot sequence
              </ListItem>
              <ListItem>
                <strong>
              ...
              <ListItem>
                ...
                (GitHub) — Hook-to-event mapping, real-time monitoring patterns,
                security hooks
              </ListItem>
              <ListItem>
      ...
      <Section title="Architecture">
        ...
        <ContentCard className="mb-8">
          ...
          <p className="mb-4 text-muted-foreground">
            ...
            adversarial networks: a generator produces work, and an independent
            evaluator judges it. A third agent handles initialization, creating
            the structured inputs that drive the entire lifecycle.
          </p>
          <ol className="space-y-4 text-muted-foreground">
            ...
            <li className="flex items-start">
              ...
              <div>
                ...
                criteria: design quality, originality, craft, and functionality.
                A separated evaluator overcomes self-evaluation bias — tuning a
                standalone evaluator to be skeptical is far more tractable than
      ...
      → needs_evaluation
        → complete`}
            ...
            <p className="mt-4 text-muted-foreground">
              ...
              dispatch next. File-based state survives context resets, providing
              clean handoffs between sessions.
            </p>
          </ContentCard>
          <ContentCard>
            <h3 className="mb-4 text-xl font-semibold">Key Design Decisions</h3>
            <BulletedList>
              <ListItem>
              ...
              <ListItem>
                Atomic file writes with temp files and rename prevent corruption
              </ListItem>
              <ListItem>
...
const report = EvaluationReportSchema.parse(data);`}
            ...
            <p className="mt-4 text-muted-foreground">
              ...
              can&apos;t accidentally corrupt the shared state that coordinates
              multi-session work.
            </p>
          </ContentCard>
          <ContentCard>
        ...
        <ContentCard className="mt-8">
          ...
          <BulletedList>
            ...
            <ListItem>
              Biome for code quality enforcement via SDK hooks — commits blocked
              on lint errors
            </ListItem>
            <ListItem>
            ...
            <ListItem>
              Bun runtime for native TypeScript execution without transpilation
              and fast startup
            </ListItem>
            <ListItem>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div>
              <p className="mb-4 text-lg text-muted-foreground">
                ...
                models begin wrapping up work prematurely as they approach what
                they believe is their context limit. This manifests as rushing
                through implementation, cutting corners, and declaring victory
                early.
              </p>
              <p className="mb-4 text-lg text-muted-foreground">
                ...
                encoding all progress into structured files that survive window
                resets, so no institutional knowledge is lost when the context
                is cleared.
              </p>
            </div>
            <div>
              ...
              <BulletedList>
                ...
                <ListItem>
                  <code>evaluation_report.json</code> with structured scores and
                  actionable feedback
                </ListItem>
                <ListItem>
                  Boot sequence saves tokens by prescribing startup steps every
                  session
                </ListItem>
                <ListItem>
                  Git history with descriptive commits enables agents to revert
                  failed changes
                </ListItem>
              </BulletedList>
            </div>
      ...
      <Section title="Project Validation">
        <div className="grid gap-8 md:grid-cols-2">
          <div className="rounded-lg bg-card p-6">
            <h3 className="mb-4 text-xl font-semibold">Phase 1: Hello World</h3>
            <p className="text-lg text-muted-foreground">
              Validates the full agent stack end-to-end with a simple HTTP
              server. Tests the complete lifecycle: initialization generates the
              feature list and scaffolds the project, the generator implements
              features one at a time with proper commits, and the evaluator
              verifies the running application via browser automation.
            </p>
          </div>
          <div className="rounded-lg bg-card p-6">
            <h3 className="mb-4 text-xl font-semibold">
            ...
            <p className="text-lg text-muted-foreground">
              ...
              creation, and updates as MCP tools with Zod-validated schemas for
              API responses.
            </p>
          </div>
        </div>
