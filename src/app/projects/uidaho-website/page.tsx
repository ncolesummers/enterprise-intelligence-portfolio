    ...
    <main id="main-content" className="sheet">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <div>
            <p className="mb-4 text-lg text-muted-foreground">
              ...
              presence, transitioning to a headless CMS architecture powered by
              Sitecore and Next.js.
            </p>
            <p className="mb-4 text-lg text-muted-foreground">
          ...
          <ContentCard>
            ...
            <BulletedList>
              ...
              <ListItem>Azure Blob Storage for media asset management</ListItem>
              <ListItem>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                React components to backend Azure services. Focused on creating
                a seamless integration between Sitecore&apos;s headless CMS and
            ...
            <div>
              ...
              <BulletedList>
                <ListItem>
                  ...
                  them in Storybook for consistent UI patterns
                </ListItem>
                <ListItem>
      ...
      <Section title="Key Features & Technologies">
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <ContentCard>
            ...
            <p className="mb-3 text-muted-foreground">
              Implemented a headless CMS architecture connecting Sitecore to the
              Next.js frontend via REST APIs and GraphQL.
            </p>
            <BulletedList>
          ...
          <ContentCard>
            <h3 className="mb-3 text-lg font-semibold">Performance & Azure</h3>
            <p className="mb-3 text-muted-foreground">
        ...
        <ContentCard>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div>
              ...
              <BulletedList>
                <ListItem>
                  <strong className="mr-1">Next.js:</strong>React framework with
      ...
      <Section title="Project Impact">
        <ContentCard>
          ...
          <p className="mb-4 text-muted-foreground">
            The redesigned University of Idaho website represents a significant
            technological advancement from the legacy system, delivering
      ...
      <Section title="Website Showcase">
        <p className="mb-6 text-muted-foreground">
          Explore screenshots of key pages from the University of Idaho website.
          Switch between tabs to view different sections of the site, showcasing
          the modern design and comprehensive content architecture.
        </p>
