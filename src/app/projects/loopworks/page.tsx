...
export default function LoopworksPage() {
  return (
    <main id="main-content" className="sheet">
      ...
      <CaseStudySection title="Admission">
        <div className="grid gap-8 md:grid-cols-2">
          <div className="type-body text-line-soft measure space-y-4">
            <p>
              ...
              outright unless its <LiteralCode>x-hub-signature-256</LiteralCode>{" "}
              HMAC signature verifies.
            </p>
            <p>
              Past the signature, admission is about never doing the same work
              twice. The delivery id is claimed as an idempotency lock, and then
              the run takes a lease. The concurrency group is scoped per
            ...
            <p>
              Admission is not a silent filter. It ends in one of three recorded
              outcomes, and a run that was refused is as visible as one that was
              accepted.
            </p>
          </div>
          <EvidencePanel>
            ...
            <EvidenceList>
              <EvidenceItem>
                ...
                <LiteralCode>agent-ready</LiteralCode> label. An issue carrying{" "}
                <LiteralCode>status:blocked</LiteralCode> does not start a run.
              </EvidenceItem>
              <EvidenceItem>
              ...
              <EvidenceItem>
                <strong className="text-line">Lease:</strong> one run in flight
                per repository.
              </EvidenceItem>
              <EvidenceItem>
      ...
      <CaseStudySection title="The Development Loop">
        <p className="type-body text-line-soft measure mb-8">
          Eight stages, declared as a constant rather than assembled at runtime.
          Each names its actor and the artifacts that have to exist before the
          run moves on.
        </p>
        ...
        <div className="mt-8 grid gap-8 md:grid-cols-2">
          <EvidencePanel>
            ...
            <p className="type-body text-line-soft">
              ...
              expected to be red. The stage advances only when every acceptance
              criterion has expected assertion-failure evidence behind it. A
              crash does not qualify, and neither does a test that passes.
            </p>
          </EvidencePanel>
          <EvidencePanel>
            <h3 className="type-title mb-4">
      ...
      <CaseStudySection title="Where Judgment Stays Human">
        <div className="grid gap-8 md:grid-cols-2">
          <div className="type-body text-line-soft measure space-y-4">
            <p>
              Two approval gates interrupt the flow. Both are required, both
              list the maintainer as reviewer, and both declare a bypass policy
              of <LiteralCode>none</LiteralCode>. There is no configuration that
              turns them off and no urgent path around them.
            </p>
            <p>
              This is the part of the system I would defend first. Agents remove
              toil, and a human keeps authority over judgment. The gates are
              where that stops being a claim about how I like to design things
              and becomes a property of the running system.
            </p>
            <p>
          ...
          <EvidencePanel>
            ...
            <EvidenceList>
              ...
              <EvidenceItem>
                ...
                sits before the only write to GitHub and requires a diff summary
      ...
      <CaseStudySection title="Why It Is a Loop">
        <div className="grid gap-8 md:grid-cols-2">
          <div className="type-body text-line-soft measure space-y-4">
            <p>
              Code review emits a recommendation, and only the root orchestrator
              applies it. A subagent can say what it thinks should happen; it
              cannot make it happen.
            </p>
            <p>
              A cycle reuses the existing rows, increments attempts, and resets
              the artifacts it invalidated. The approved plan is retained across
              the cycle, so going back to development is not going back to the
              beginning.
            </p>
            <p>
          ...
          <EvidencePanel>
            <h3 className="type-title mb-4">Three routes out of code review</h3>
            <EvidenceList>
              <EvidenceItem>
              ...
              <EvidenceItem>
                <strong className="text-line">Requeue test writing.</strong> The
                tests themselves were wrong, so they are rewritten first.
              </EvidenceItem>
            </EvidenceList>
          </EvidencePanel>
        </div>
      ...
      <CaseStudySection title="Isolation and the Guarded Write">
        <div className="grid gap-8 md:grid-cols-2">
          <div className="type-body text-line-soft measure space-y-4">
            <p>
              Each subagent declares its own sandbox. The implementer works in a
              checkout pinned to a commit, with a{" "}
            ...
            <p>
              ...
              root invokes the transition. Five subagents are present in source:
              planner, test writer, implementer, validation reviewer, and PR
              preparer.
            </p>
            <p>
          ...
          <EvidencePanel>
            ...
            <p className="type-body text-line-soft mt-6">
              ...
              they cannot be rolled back with it. The branch name and the commit
              trailers are the reconciliation key when the two disagree.
            </p>
          </EvidencePanel>
        </div>
      </CaseStudySection>

      <CaseStudySection title="The Control Plane">
        <div className="grid gap-8 md:grid-cols-2">
          <div className="type-body text-line-soft measure space-y-4">
            <p>
            ...
            <p>
              ...
              visibility surface for previews, deployments, and build status, so
              the places a reviewer already looks are the places the loop
              reports into.
            </p>
            <p>
              ...
              not drawn in FIG. 1: showing a parallel skeleton would double the
              figure&apos;s width and halve its legibility.
            </p>
          </div>
          <EvidencePanel>
