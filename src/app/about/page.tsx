    ...
    <main id="main-content" className="sheet">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <div>
            ...
            <p className="mb-4 text-lg text-muted-foreground">
              ...
              shaped how I think about human-AI collaboration: what to automate,
              what to leave to developers, and where the boundaries should be.
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Designing agent workflows that handle code review, testing,
                    and deployment tasks autonomously.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
      ...
      <Section title="Philosophy & Approach">
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div>
            <p className="mb-4 text-lg text-muted-foreground">
              I believe the best AI-assisted workflows are the ones where humans
              stay in the driver&apos;s seat. Automation should eliminate toil,
              not judgment. It frees developers to focus on architecture,
              design, and the decisions that matter.
            </p>
            <p className="mb-4 text-lg text-muted-foreground">
              I&apos;m drawn to the intersection of AI-powered developer tools
              and enterprise software, where automation can meaningfully reduce
              cycle time without sacrificing reliability or developer trust.
            </p>
            <p className="text-lg text-muted-foreground">
              I strongly believe in blameless postmortems as a way to build
              stronger teams and better systems. This approach fosters a culture
              of learning and improvement rather than finger-pointing.
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section title="Beyond the Code">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <ContentCard>
            ...
            <p className="text-muted-foreground">
              Occasionally dive into video games as a way to unwind and explore
              interactive storytelling and creative problem-solving.
            </p>
          </ContentCard>
          <ContentCard>
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-muted">
            ...
            <p className="text-muted-foreground">
              Can always be tempted away from work with the promise of good food
              and live music. It&apos;s the perfect combination for recharging.
            </p>
          </ContentCard>
        </div>
      </Section>
